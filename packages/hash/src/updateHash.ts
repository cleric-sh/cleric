...
export const updateHash = (hashState: HashState<any>, path: string[], value: any, depth = 0) => {
  if (depth < path.length) {
    ...
    hashState.__hash = Object.getOwnPropertyNames(hashState).reduce((acc, propName) => {
