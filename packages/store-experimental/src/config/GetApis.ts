...
export type GetApis<TConfigKey extends ConfigKey,
                                       TConfig = NonNullable<ConfigTypes[TConfigKey]>> = TConfig extends Config ?
    TConfig['apis'] extends List.List<infer L>?
    Union.ListOf<L>  // This step ensures that typed arrays are
