...
export class TestSlice<
    TConfigKey extends ConfigKey, P extends t.InterfaceType<t.Props>, K extends
        keyof SliceParentProps<P>> extends SliceNode<TConfigKey, P, K> {
...
declare module '../../slice/node' {
  interface SliceNodeTypes<TConfigKey extends ConfigKey, P extends
