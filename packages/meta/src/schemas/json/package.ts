...
export interface Package {
   ...
   * recommended that you install any binaries as local devDependencies wherever
   * possible.
   */
  ...
  scripts?: Scripts;
  /**
   * The type field defines how .js and extensionless files should be treated
   * within a particular package.json file’s package scope. Supported values:
  ...
  version?: string;
  /**
   * To configure your yarn workspaces, please note private should be set to
   * true to use yarn workspaces
   */
  workspaces?: any;
  jspm?: CoreProperties;
...
export interface Directories {
  /**
   * If you specify a 'bin' directory, then all the files in that folder will be
   * used as the 'bin' hash.
   */
  bin?: string;
  /**
  ...
  example?: string;
  /**
   * Tell people where the bulk of your library is. Nothing special is done with
   * the lib folder in any way, but it's useful meta info.
   */
  lib?: string;
  /**
...
export interface Scripts {
  ...
  prepare?: string;
  /**
   * Run BEFORE the package is published (Also run on local npm install without
   * any arguments)
   */
  prepublish?: string;
  /**
