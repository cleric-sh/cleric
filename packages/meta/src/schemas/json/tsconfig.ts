...
export interface Tsconfig {
   ...
   *
   * ts-node offers TypeScript execution and REPL for node.js, with source map
   * support.
   */
  "ts-node"?: TsNode;
  /**
...
export interface TsconfigCompilerOptions {
  ...
  /**
   * Parse in strict mode and emit 'use strict' for each source file. Requires
  ...
  /**
   * Generates a sourcemap for each corresponding '.d.ts' file. Requires
  ...
  diagnostics?: boolean;
  /**
   * Disable size limit for JavaScript project. Requires TypeScript version 2.0
   * or later.
   */
  disableSizeLimit?: boolean;
  /**
   * Provide full support for iterables in 'for-of', spread, and destructuring
   * when targeting 'ES5' or 'ES3'. Requires TypeScript version 2.3 or later.
   */
   ...
   * typesystem compatibility. Requires TypeScript version 2.7 or later.
   */
   ...
   * symbols). Requires TypeScript version 2.9 or later.
   */
  keyofStringsOnly?: boolean;
  /**
   * List of library files to be included in the compilation. Possible values
   * are: 'ES5', 'ES6', 'ES2015', 'ES7', 'ES2016', 'ES2017', 'ES2018', 'ESNext',
   ...
   * 'ES6', 'ES2015', 'ES2020' or 'ESNext'. Only 'AMD' and 'System' can be used
   * in conjunction with
   * --outFile.
   */
  module?: string;
  /**
   * Specifies module resolution strategy: 'node' (Node) or 'classic'
   * (TypeScript pre 1.6) .
   */
  moduleResolution?: string;
  /**
   * Specifies the end of line sequence to be used when emitting files: 'crlf'
   * (Windows) or 'lf' (Unix).
   */
  newLine?: string;
  /**
  ...
  /**
   * Report errors on unused parameters. Requires TypeScript version 2.0 or
   * later.
   */
  ...
  /**
   * List of TypeScript language server plugins to load. Requires TypeScript
  ...
  pretty?: boolean;
  /**
   * Specifies the object invoked for createElement and __spread when targeting
   * 'react' JSX emit.
   */
  ...
  /**
   * Include modules imported with '.json' extension. Requires TypeScript
  ...
  /**
   * Skip type checking of declaration files. Requires TypeScript version 2.0 or
   * later.
   */
  ...
  sourceRoot?: string;
  /**
   * Enable all strict type checking options. Requires TypeScript version 2.3 or
   * later.
   */
  strict?: boolean;
  /**
  ...
  /**
   * Disable bivariant parameter checking for function types. Requires
  ...
  /**
   * Specify ECMAScript target version: 'ES3', 'ES5', 'ES6'/'ES2015', 'ES2016',
  ...
  types?: string[];
  /**
   * Emit ECMAScript standard class fields. Requires TypeScript version 3.7 or
   * later.
   */
...
export interface TsNode {
  ...
  /**
   * **DEPRECATED** Specify type-check is enabled (e.g. `transpileOnly ==
   * false`).
   */
  typeCheck?: boolean;
}
          ...
          [
            {
              ...
              js : "compilerOptions",
              typ : u(undefined, r("TsconfigCompilerOptions"))
            },
            {
              json : "compileOnSave",
              js : "compileOnSave",
            ...
            },
            {
              ...
              js : "typeAcquisition",
              typ : u(undefined, r("TypeAcquisition"))
            },
          ...
          o(
              [
                {json : "allowJs", js : "allowJs", typ : u(undefined, true)},
                {
                  ...
                  js : "allowSyntheticDefaultImports",
                  typ : u(undefined, true)
                },
                {
                  json : "allowUmdGlobalAccess",
                  js : "allowUmdGlobalAccess",
                  typ : u(undefined, true)
                },
                {
                  json : "allowUnreachableCode",
                  js : "allowUnreachableCode",
                  typ : u(undefined, true)
                },
                {
                  json : "allowUnusedLabels",
                  js : "allowUnusedLabels",
                  typ : u(undefined, true)
                },
                {
                  json : "alwaysStrict",
                ...
                {
                  json : "assumeChangesOnlyAffectDirectDependencies",
                  js : "assumeChangesOnlyAffectDirectDependencies",
                  typ : u(undefined, true)
                },
                ...
                {
                  json : "disableSizeLimit",
                  js : "disableSizeLimit",
                  typ : u(undefined, true)
                },
                {
                  json : "downlevelIteration",
                  js : "downlevelIteration",
                  typ : u(undefined, true)
                },
                {json : "emitBOM", js : "emitBOM", typ : u(undefined, true)},
                {
                  json : "emitDeclarationOnly",
                  js : "emitDeclarationOnly",
                  typ : u(undefined, true)
                },
                {
                  json : "emitDecoratorMetadata",
                  js : "emitDecoratorMetadata",
                  typ : u(undefined, true)
                },
                {
                  json : "esModuleInterop",
                  js : "esModuleInterop",
                  typ : u(undefined, true)
                },
                {
                  json : "experimentalDecorators",
                  js : "experimentalDecorators",
                  typ : u(undefined, true)
                },
                {
                  json : "forceConsistentCasingInFileNames",
                  js : "forceConsistentCasingInFileNames",
                  typ : u(undefined, true)
                },
                {
                  json : "importHelpers",
                ...
                {
                  json : "importsNotUsedAsValues",
                  js : "importsNotUsedAsValues",
                  typ : u(undefined, r("ImportsNotUsedAsValues"))
                },
                {
                  json : "incremental",
                  js : "incremental",
                ...
                {
                  json : "keyofStringsOnly",
                  js : "keyofStringsOnly",
                  typ : u(undefined, true)
                },
                {json : "lib", js : "lib", typ : u(undefined, a(""))},
                {
                  json : "listEmittedFiles",
                  js : "listEmittedFiles",
                  typ : u(undefined, true)
                },
                {
                ...
                {
                  json : "maxNodeModuleJsDepth",
                  js : "maxNodeModuleJsDepth",
                  typ : u(undefined, 3.14)
                },
                {json : "module", js : "module", typ : u(undefined, "")},
                {
                  json : "moduleResolution",
                  js : "moduleResolution",
                  typ : u(undefined, "")
                },
                ...
                {
                  json : "noErrorTruncation",
                  js : "noErrorTruncation",
                  typ : u(undefined, true)
                },
                {
                  json : "noFallthroughCasesInSwitch",
                  js : "noFallthroughCasesInSwitch",
                  typ : u(undefined, true)
                },
                {
                  json : "noImplicitAny",
                ...
                {
                  json : "noImplicitReturns",
                  js : "noImplicitReturns",
                  typ : u(undefined, true)
                },
                {
                  json : "noImplicitThis",
                ...
                {
                  json : "noImplicitUseStrict",
                  js : "noImplicitUseStrict",
                  typ : u(undefined, true)
                },
                ...
                {
                  json : "noStrictGenericChecks",
                  js : "noStrictGenericChecks",
                  typ : u(undefined, true)
                },
                {
                  json : "noUnusedLocals",
                ...
                {
                  json : "noUnusedParameters",
                  js : "noUnusedParameters",
                  typ : u(undefined, true)
                },
                ...
                {json : "paths", js : "paths", typ : u(undefined, m(a("")))},
                {
                  json : "plugins",
                  js : "plugins",
                  typ : u(undefined, a(r("Plugin")))
                },
                {
                  json : "preserveConstEnums",
                  js : "preserveConstEnums",
                  typ : u(undefined, true)
                },
                {
                  json : "preserveSymlinks",
                  js : "preserveSymlinks",
                  typ : u(undefined, true)
                },
                {
                  json : "preserveWatchOutput",
                ...
                {
                  json : "strictBindCallApply",
                  js : "strictBindCallApply",
                  typ : u(undefined, true)
                },
                {
                  json : "strictFunctionTypes",
                  js : "strictFunctionTypes",
                  typ : u(undefined, true)
                },
                {
                  json : "strictNullChecks",
                  js : "strictNullChecks",
                  typ : u(undefined, true)
                },
                {
                  json : "strictPropertyInitialization",
                  js : "strictPropertyInitialization",
                  typ : u(undefined, true)
                },
                {
                  json : "stripInternal",
                ...
                {
                  json : "suppressExcessPropertyErrors",
                  js : "suppressExcessPropertyErrors",
                  typ : u(undefined, true)
                },
                {
                  json : "suppressImplicitAnyIndexErrors",
                  js : "suppressImplicitAnyIndexErrors",
                  typ : u(undefined, true)
                },
                {json : "target", js : "target", typ : u(undefined, "")},
                {
                  json : "traceResolution",
                  js : "traceResolution",
                  typ : u(undefined, true)
                },
                {
                  json : "tsBuildInfoFile",
                  js : "tsBuildInfoFile",
                  typ : u(undefined, "")
                },
                {
